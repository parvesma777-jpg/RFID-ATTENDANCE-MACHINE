...
int startHours = 19, startMinutes = 42, startSeconds = 50;  // Manually set initial time
...
UserData userList[] = {
    {"522ad71b", "11101", "Arun", "", false},
    {"df59462e", "11102", "Deepak", "", false},
    {"423fde1b", "11103", "John", "", false},
};
